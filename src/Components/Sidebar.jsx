...
// //         toast.success(`Table '${data?.table_name}' created`, { position: "bottom-center", autoClose: 3000 });
...
// //   return (
// //     <div
// //       className={`fixed top-16 left-0 h-[calc(100vh-4rem)] bg-white border-r border-gray-300 px-6 py-6 z-30 transition-transform duration-300 ease-in-out transform ${isOpen ? "translate-x-0 w-80" : "-translate-x-full w-80"
// //         } font-sans text-gray-800 text-[15px] leading-relaxed overflow-y-auto`}
// //     >
// //       {/* About Section */}
// //       <div className="mb-6">
...
// //       if (!showSchema && !schemaText) fetchSchema(); // Fetch only once
// //     }}
// //   >
// //     <span className="font-light text-gray-700 group-hover:text-orange-500 transition-colors">
// //       View Schema
...
// //                 <button
// //                   className="text-red-500 hover:text-red-700"
// //                   onClick={() => handleRemoveHistory(index)}  // index is from reverse loop
// //                   title="Remove query"
// //                 >
// //                   <FiX />
// //                 </button>
...
//           <button
//             onClick={() => fileInputRef.current.click()}
//             className="w-full mt-1 px-3 py-2 bg-blue-600 text-white text-sm rounded hover:bg-blue-700"
//           >
//             Browse Files
//           </button>
//         </div>
